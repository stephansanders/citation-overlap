; Citation-Overlap Installer Script
...
; set up defaults
  ...
  !define APP_NAME "Citation-Overlap"
  !define APP_NAME_VER "${APP_NAME}-${VER}"
  !define APP_DESC "${APP_NAME}: a resolver for overlapping citation lists"
...
; set up pages
  ...
  !define MUI_WELCOMEPAGE_TEXT "Welcome to ${APP_NAME}, a tool for merging citation lists from multiple bibliographic sources based on overlapping records."
  ...
  !define MUI_FINISHPAGE_LINK_LOCATION https://github.com/stephansanders/citation-overlap
...
Section "CitationOverlap" SecApp
 
  SetOutPath "$INSTDIR"

  ; install app folder built by PyInstaller
...
; languages
  ...
  !insertmacro MUI_FUNCTION_DESCRIPTION_BEGIN
    !insertmacro MUI_DESCRIPTION_TEXT ${SecApp} $(DESC_MAGMAP)
